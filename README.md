...
There is a fee of <img src="https://render.githubusercontent.com/render/math?math=log(AMOUNT PER POSITION)*LEVERAGE*0.3"> usdt:
- Each day;
...
Examples:
- With 1.5 as AMOUNT PER POSITION and 10 as LEVERAGE you have a fee of: usdt <img src="https://render.githubusercontent.com/render/math?math=log(1.5)*10*0.3 = 0.528">
