...
There is a fee of log(AMOUNT PER POSITION)\u2715LEVERAGE&bull;0.3 usdt: <img src="https://render.githubusercontent.com/render/math?math=log(AMOUNT PER POSITION)*LEVERAGE*0.3">
- Each day;
